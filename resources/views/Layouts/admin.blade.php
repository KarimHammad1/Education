        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              ...
              <li>
                <a href="/admin/teachers" class="active"> Add Teachers </a>
              </li>
              <li>
                <a href="/admin/courses" class="active"> Courses </a>
              </li>
              <li>
                <a href="/admin/enrollcourses" class="active">Enroll Courses</a>
              </li>
              <li>
                <a href="/admin/quizzes" class="active">Quizzes</a>
              </li>
              <li>
                  ...
                  >
                    <div class="profile-info">
                      <div class="info">
                        ...
                        <div class="image">
                          <img
                            src="{{ asset('image/profile/profile-image.png') }}"
                            alt=""
                          />
